...
interface CameraMinimalisticProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

export const CameraMinimalistic = ({
  size = 24,
  color,
  className,
  ...props
}: CameraMinimalisticProps) => {
  return (
    <svg
      width={size}
      height={size}
