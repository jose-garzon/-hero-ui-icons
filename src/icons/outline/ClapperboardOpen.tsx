...
interface ClapperboardOpenProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

export const ClapperboardOpen = ({
  size = 24,
  color,
  className,
  ...props
}: ClapperboardOpenProps) => {
  return (
    <svg
      width={size}
      height={size}
