...
interface LightbulbBoltProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

export const LightbulbBolt = ({
  size = 24,
  color,
  className,
  ...props
