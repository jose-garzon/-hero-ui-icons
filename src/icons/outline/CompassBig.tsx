...
interface CompassBigProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

export const CompassBig = ({
  size = 24,
  color,
  className,
  ...props
