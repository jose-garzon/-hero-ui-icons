...
interface CloudPlusProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

export const CloudPlus = ({
  size = 24,
  color,
  className,
  ...props
