...
interface CloundCrossProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

export const CloundCross = ({
  size = 24,
  color,
  className,
  ...props
