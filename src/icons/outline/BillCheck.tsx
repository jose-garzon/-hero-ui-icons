...
interface BillCheckProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

export const BillCheck = ({
  size = 24,
  color,
  className,
  ...props
