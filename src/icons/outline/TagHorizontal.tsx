...
interface TagHorizontalProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

export const TagHorizontal = ({
  size = 24,
  color,
  className,
  ...props
