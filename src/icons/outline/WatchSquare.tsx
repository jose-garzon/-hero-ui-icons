...
interface WatchSquareProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

export const WatchSquare = ({
  size = 24,
  color,
  className,
  ...props
