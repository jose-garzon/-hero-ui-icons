...
interface CloudSnowfallProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

export const CloudSnowfall = ({
  size = 24,
  color,
  className,
  ...props
