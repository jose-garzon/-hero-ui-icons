...
interface CloudMinusProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

export const CloudMinus = ({
  size = 24,
  color,
  className,
  ...props
