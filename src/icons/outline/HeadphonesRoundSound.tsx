...
interface HeadphonesRoundSoundProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

export const HeadphonesRoundSound = ({
  size = 24,
  color,
  className,
  ...props
}: HeadphonesRoundSoundProps) => {
  return (
    <svg
      width={size}
      height={size}
