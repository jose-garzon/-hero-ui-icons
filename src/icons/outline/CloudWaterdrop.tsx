...
interface CloudWaterdropProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

export const CloudWaterdrop = ({
  size = 24,
  color,
  className,
  ...props
