...
interface RemoteControllerMinimalisticProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

export const RemoteControllerMinimalistic = ({
  size = 24,
  color,
  className,
  ...props
}: RemoteControllerMinimalisticProps) => {
  return (
    <svg
      width={size}
      height={size}
