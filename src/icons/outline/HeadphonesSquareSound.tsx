...
interface HeadphonesSquareSoundProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

export const HeadphonesSquareSound = ({
  size = 24,
  color,
  className,
  ...props
}: HeadphonesSquareSoundProps) => {
  return (
    <svg
      width={size}
      height={size}
