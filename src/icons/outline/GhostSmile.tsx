...
interface GhostSmileProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

export const GhostSmile = ({
  size = 24,
  color,
  className,
  ...props
