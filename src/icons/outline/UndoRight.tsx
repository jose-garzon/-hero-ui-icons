...
interface UndoRightProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

export const UndoRight = ({
  size = 24,
  color,
  className,
  ...props
