...
interface CallMedicineRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

export const CallMedicineRounded = ({
  size = 24,
  color,
  className,
  ...props
}: CallMedicineRoundedProps) => {
  return (
    <svg
      width={size}
      height={size}
