...
interface Routing3Props extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

export const Routing3 = ({
  size = 24,
  color,
  className,
  ...props
